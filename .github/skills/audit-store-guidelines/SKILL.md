...
Audit the codebase's data collection endpoints to ensure accurate App Privacy labels can be generated, explicitly stating what is sent to third-party AI LLMs.
