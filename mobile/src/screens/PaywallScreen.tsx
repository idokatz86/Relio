...
const PLANS = [
  {
    ...
    name: 'Solo',
    price: '$9.99/mo',
    description: 'Unlimited AI coaching & exercises',
    features: ['Private journal', 'AI coaching sessions', 'Attachment assessment', 'Psychoeducation'],
    highlight: false,
  },
  {
    id: 'couples',
    name: 'Couples',
    price: '$14.99/mo',
    description: 'Full mediation for both partners',
    features: ['Everything in Solo', 'SharedChat mediation', 'Partner invite', 'Communication tracking'],
    highlight: true,
  },
  {
    id: 'plus',
    name: 'Premium+',
    price: '$24.99/mo',
    description: 'Crisis support & priority',
    features: ['Everything in Couples', 'Crisis support', 'Priority AI response', 'Therapist handoff'],
    highlight: false,
  },
];
